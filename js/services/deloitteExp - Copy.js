profileApp.service('deloitteExp', function(){
	return {
		items : [
					{
						...
						thumbnailurl: 'img/thumbnail/projects/BussinessChemistry.gif',
						linkurl:'https://businesschemistry.deloitte.com',
						targetlink:'_blank',
						thumblabel: 'SPA using Knockout',
						roles: [
							{
					...
					{
						name:'Dpool',
						description:'Dpool is a Vehicle pooling Mobile Application(also known as car-sharing, ride-sharing and lift-sharing), is the sharing of car journeys / bike rides so that more than one person travels in a vehicle. It is a more environmental friendly and sustainable way to travel as sharing journeys reduces carbon emissions, traffic on the roads, and the need for parking spaces.',
						technologies:'Angular.js, Boostrap3, JQuery',
						companyname:'Deloitte',
						fromdate:'Dec-2013',
						todate:'March-2014',
						imageurl:'img/Dpool.png',
						thumbnailurl: 'img/thumbnail/projects/Dpool.gif',
						linkurl:'#',
						targetlink:'',
						thumblabel: 'SPA using Angular',
						roles: [
							{
								list:'Developed the View model using Knockout.js'
							},
					...
					},
					{
						...
						thumbnailurl: 'img/thumbnail/projects/IVR.gif',
						linkurl:'#',
						targetlink:'',
						thumblabel: 'SPA using Knockout',
						roles: [
					...
					},
					{
						...
						thumbnailurl: 'img/thumbnail/projects/TalentOnDemand.gif',
						linkurl:'#',
						targetlink:'',
						thumblabel: 'SPA using Knockout',
						roles: [
					...
					},
					{
						...
						technologies:'ASP.Net MVC, HTML, CSS, Boostrap3',
						companyname:'Deloitte',
						fromdate:'Dec-2013',
						todate:'March-2014',
						imageurl:'img/ProjectTracker.png',
						thumbnailurl: 'img/thumbnail/projects/ProjectTracker.gif',
						linkurl:'#',
						targetlink:'',
						thumblabel: 'Application using Asp.net MVC',
						roles: [
							{
								list:'Developed pages using ASP.net MVC'
							},
							{
								list:'Developed the HTML’s & CSS.'
							},
							{
								list:'Handled Cross browser compatible development'
							}
						]
					}
				]
